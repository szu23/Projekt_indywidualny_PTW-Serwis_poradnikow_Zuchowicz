...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($tresc_err == "") {
        $stmt = $polaczenie->prepare("UPDATE komentarze SET tresc_komentarza = ? WHERE id_komentarza = ? AND id_uzytkownika = ?");
    ...
    $stmt = $polaczenie->prepare("SELECT id_komentarza, id_posta, tresc_komentarza FROM komentarze WHERE id_komentarza = ? AND id_uzytkownika = ?");
